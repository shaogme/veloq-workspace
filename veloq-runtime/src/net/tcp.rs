...
impl<S: OpSubmitter, P: SocketTokenPtr> GenericTcpListener<S, P> {
...
impl<S: OpSubmitter, P: SocketTokenPtr> GenericTcpStream<S, P> {
    ...
    pub async fn accept(&self) -> io::Result<(TcpStream, SocketAddr)> {
            ...
            .is_some_and(|ctx| ctx.handle.id() != self.inner.owner_worker_id())
        {
            ...
            return crate::runtime::context::spawn_to(
                ...
                move || async move { this.accept_direct().await },
            )
            .await;
        }
