...
impl RioState {
    #[inline]
    pub(crate) fn is_iocp_fallback(&self, actor_key: (HANDLE, u32)) -> bool {
    ...
    #[inline]
    pub(crate) fn maybe_mark_iocp_fallback(&mut self, actor_key: (HANDLE, u32), err: &io::Error) {
